...
public class CustomerMenu {
    ...
    private static void updateInfo(Scanner scan, String[] user) {
        System.out.println("\n\t\t\tYour Information");
        MyLogger.writeToLog("Customer " + user[0] + " accessed personal info update.");
        ...
        try {
            ...
            System.out.println("Invalid input. Please enter a number.");
            MyLogger.writeToLog("Invalid input in update info by customer: " + user[0]);
            scan.nextLine();
            return;
        }
        ...
        switch (choice) {
            case 1:
                ...
                MyLogger.writeToLog("Customer " + user[0] + " updated their name.");
                break;
            case 2:
                ...
                MyLogger.writeToLog("Customer " + user[0] + " updated their contact number.");
                break;
            case 3:
                ...
                if (!PasswordPolicy.validate(newPassword)) {
                    ...
                    MyLogger.writeToLog("Customer " + user[0] + " password change failed: policy not met.");
                    return;
                }
                user[1] = AuthService.getSHA256Hash(newPassword);
                UserStore.updateUser(user[0], user);
                System.out.println("Password updated.");
                MyLogger.writeToLog("Password changed for customer: " + user[0]);
                break;
            case 4:
                MyLogger.writeToLog("Customer " + user[0] + " went back from update info.");
                break;
            default:
